...
void modules::weapon::no_recoil::callback()
{
	...
	if (std::get< bool >(menu::config::config_map["enable_no_recoil"]))
	{
		...
		engine::structures::vector2_t recoil_xy{ std::get< int >(menu::config::config_map["recoil_x"]), std::get< int >(menu::config::config_map["recoil_y"]) };
		engine::structures::vector2_t recoil_depth_xy{ std::get< int >(menu::config::config_map["recoil_depth_x"]), std::get< int >(menu::config::config_map["recoil_depth_y"]) };

		recoil_xy.x += modules::weapon::math::generate_random_number(std::get< int >(menu::config::config_map["recoil_random_x"]), std::get< int >(menu::config::config_map["recoil_random_y"]));
		recoil_xy.y += modules::weapon::math::generate_random_number(std::get< int >(menu::config::config_map["recoil_random_x"]), std::get< int >(menu::config::config_map["recoil_random_y"]));

		recoil_depth_xy.x += modules::weapon::math::generate_random_number(std::get< int >(menu::config::config_map["recoil_random_x"]), std::get< int >(menu::config::config_map["recoil_random_y"]));
		recoil_depth_xy.y += modules::weapon::math::generate_random_number(std::get< int >(menu::config::config_map["recoil_random_x"]), std::get< int >(menu::config::config_map["recoil_random_y"]));
